...
//     //6:创建sql语句
//     //自己写:库名;表名;列名 小写
//     var sql = "SELECT did,title,price,leixing,huxing,louceng,mianji,chaoxiang FROM guike_detail";
//     var sql1="SELECT did,title,price,leixing,huxing,louceng,mianji,chaoxiang FROM guike_detail_pic";
//     //7:执行sql语句
