    ...
    <div>
        <div class="shoutu">
            ...
            <div class="xinxi">
                ...
                <p style="color:#fff;font-size:15px;">15303819591</p>
            </div>
        </div>
        <!-- 四个按钮 -->
        ...
        <mt-cell title="关于龟壳" to="//github.com" is-link>
